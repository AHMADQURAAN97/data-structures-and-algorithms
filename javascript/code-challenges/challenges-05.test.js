...
const addPurchases = (arr) => {
  ...
  let purchasee = arr.reduce((accum,value) =>{

    accum=accum+value.purchasePrice
    return accum
  },0)
  return purchasee
};
...
const returnNames = (arr) => {
  ...
  let names =arr.reduce((accum,value)=>{
...
const reversedString = (str) => {
  ...
  let star = array.length;
  var newArr= new Array (length);
  let reverse = array.reduce((accum,value,indix)=> {
  ...
  let string = newArr.reduce((accum,value,indix)=>{
...
const countNumberOfChildren = (arr) => {
  // Solution code here...
   ...
   let newArray = arr.reduce((accum , value) => {
